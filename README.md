...
```javascript
FLOAT32_GAMMA_LANCZOS_G = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-gamma-lanczos-g@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-gamma-lanczos-g/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-gamma-lanczos-g/actions/workflows/test.yml?query=branch:v0.1.1
